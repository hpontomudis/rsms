<div class="mx-auto max-w-xl space-y-4">
    ...
    <h1 class="font-serif text-xl font-bold text-brand-navy">Add Class</h1>
    ...
    <form wire:submit="save" class="space-y-4 rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <div>
            ...
            <input type="text" wire:model="name" placeholder="e.g. Year 5A" class="w-full rounded-md border border-slate-300 px-3 py-2.5 text-base focus:border-brand-navy focus:ring-1 focus:ring-brand-navy">

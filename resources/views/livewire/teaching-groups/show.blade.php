            ...
            <form wire:submit="addStudent" class="mb-4 space-y-3 rounded-lg bg-slate-50 p-3">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-end">
                    <div class="sm:w-44">
                        ...
                        {{-- live: which students are eligible depends on this date,
                             since a membership already covering it would overlap. --}}
                        <input type="date" wire:model.live="started_on" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-brand-navy focus:ring-1 focus:ring-brand-navy">

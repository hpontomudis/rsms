<div class="mx-auto max-w-xl space-y-4">
    ...
    <h1 class="font-serif text-xl font-bold text-brand-navy">Add Fee Structure</h1>

    <form wire:submit="save" class="space-y-4 rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <div>
            <label class="mb-1 block text-sm font-medium text-slate-700">Name</label>
            <input type="text" wire:model="name" placeholder="e.g. Year 5 Annual Fees" class="w-full rounded-md border border-slate-300 px-3 py-2.5 text-base focus:border-brand-navy focus:ring-1 focus:ring-brand-navy">
        ...
        <div class="flex justify-end gap-3 pt-2">
            <a href="{{ route('fee-structures.index') }}" class="rounded-md border border-slate-300 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50">Cancel</a>

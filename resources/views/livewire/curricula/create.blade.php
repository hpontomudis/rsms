@php $identityEditable = true; @endphp
<div class="mx-auto max-w-2xl space-y-4">
    <a href="{{ route('curricula.index') }}" class="text-sm text-slate-500 hover:text-slate-700">&larr; Curricula</a>
    <h1 class="font-serif text-xl font-bold text-brand-navy">New Curriculum Version</h1>
    ...
    <form wire:submit="save" class="space-y-4 rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        ...
        <div class="flex flex-wrap justify-end gap-3 pt-2">
            <a href="{{ route('curricula.index') }}" class="rounded-md border border-slate-300 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50">Cancel</a>
        ...
        <p class="text-xs text-slate-500">
            Created as a draft. Activating it is a separate, deliberate step, because it supersedes
            whichever version of this curriculum is currently in force.
        </p>
    </form>
</div>

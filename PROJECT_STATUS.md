...
- **Phase 5 Steps 0-2e and Phases 5A through 5F are complete.** Nothing is in progress. V5's teaching cycle runs end to end: Curriculum → CP → TP → ATP → Prota → Prosem → Module → Journal.

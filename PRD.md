...
| Last updated | 2026-08-10 (V5.0-pre built — Phase 5 Steps 0/1/2a-i/2a-ii/2b/2c/2d/2e; V5 planning entities approved, not started) |
...
| Academic & Teaching Administration (Curriculum → CP → TP → ATP → Prota → Prosem → Teaching Modules → Daily Journals) | V5 | **In progress** — Steps 0, 1, 2a-i, 2a-ii, 2b, 2c, 2d and 2e built; teacher student-scoping not yet connected; the planning entities themselves not started |
...
| V5.0-pre | Phase 5 Step 2e — Teacher Workspace (My Teaching Assignments) | Complete (current build) |
